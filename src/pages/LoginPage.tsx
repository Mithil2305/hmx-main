...
const LoginPage: React.FC = () => {
	...
	const { login, isAuthenticated, user, hasCompletedBBD } = useAuth();
	...
	}, [isAuthenticated, user, hasCompletedBBD, navigate]);
				...
				<div className="max-w-md mx-auto">
					...
					>
						...
						<div className="bg-sidebar-bg text-white p-10 text-center relative">
							...
							<h1 className="text-3xl font-heading font-black mb-3 tracking-tight">
								Welcome Back
							</h1>
							<p className="text-zinc-400 font-medium">
								Elevate your brand with hyper-mobility
							</p>
						</div>
						...
						<div className="p-10">
							...
							<form onSubmit={handleSubmit} className="space-y-6">
								<div>
									<label
										htmlFor="email"
										className="block text-xs font-black text-zinc-500 uppercase tracking-widest mb-2 px-1"
									>
										Email Address
									</label>
									<input
									...
									/>
									{errors.email && (
										<p className="mt-2 text-[10px] font-black text-red-500 uppercase tracking-wider px-1">
											{errors.email}
										</p>
									)}
								</div>
								...
								<div>
									<div className="flex items-center justify-between mb-2 px-1">
										<label
											htmlFor="password"
											className="block text-xs font-black text-zinc-500 uppercase tracking-widest"
										>
											Password
										</label>
										<button
								...
								<div className="flex items-center px-1">
									<div className="relative flex items-start">
										...
										<div className="ml-3 text-sm">
											<label
												htmlFor="rememberMe"
												className="font-bold text-zinc-600 cursor-pointer select-none"
											>
												Remember me
											</label>
										</div>
							...
							<div className="mt-10 text-center">
								<p className="text-zinc-500 font-bold text-sm">
									...
									<Link
										to="/"
										className="text-primary-600 hover:text-primary-700 underline underline-offset-4 font-black transition-all"
									>
										Explore options
									</Link>
								</p>
